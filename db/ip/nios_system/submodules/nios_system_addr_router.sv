...
(
    ...
    localparam PAD4 = log2ceil(64'h1080 - 64'h1070); 
    localparam PAD5 = log2ceil(64'h1090 - 64'h1080); 
    localparam PAD6 = log2ceil(64'h10a0 - 64'h1090); 
    localparam PAD7 = log2ceil(64'h10b0 - 64'h10a0); 
    localparam PAD8 = log2ceil(64'h10c0 - 64'h10b0); 
    localparam PAD9 = log2ceil(64'h10e0 - 64'h10c0); 
    localparam PAD10 = log2ceil(64'h1100 - 64'h10e0); 
    ...
    // ( 0x1070 .. 0x1080 )
    if ( {address[RG:PAD4],{PAD4{1'b0}}} == 27'h1070   ) begin
            src_channel = 17'b01000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 10;
    end

    // ( 0x1080 .. 0x1090 )
    if ( {address[RG:PAD5],{PAD5{1'b0}}} == 27'h1080   ) begin
            src_channel = 17'b00100000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 9;
    end

    // ( 0x1090 .. 0x10a0 )
    if ( {address[RG:PAD6],{PAD6{1'b0}}} == 27'h1090   ) begin
            src_channel = 17'b00000001000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 8;
    end

    // ( 0x10a0 .. 0x10b0 )
    if ( {address[RG:PAD7],{PAD7{1'b0}}} == 27'h10a0   ) begin
            src_channel = 17'b10000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 7;
    end

    // ( 0x10b0 .. 0x10c0 )
    if ( {address[RG:PAD8],{PAD8{1'b0}}} == 27'h10b0   ) begin
            src_channel = 17'b00000000100000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 6;
    end

    // ( 0x10c0 .. 0x10e0 )
    if ( {address[RG:PAD9],{PAD9{1'b0}}} == 27'h10c0   ) begin
            src_channel = 17'b00000010000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 15;
    end

    // ( 0x10e0 .. 0x1100 )
    if ( {address[RG:PAD10],{PAD10{1'b0}}} == 27'h10e0   ) begin
